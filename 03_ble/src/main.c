...
This code is a first try in the BLE capabilities of the ESP32 board
All advertisements received are printed to stdout
...
void app_main(void)
{
    ...
    ESP_LOGI(GATTS_TAG, "Hello World ... This is a BlE project!\n");
